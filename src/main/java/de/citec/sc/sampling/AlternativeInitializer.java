...
public class AlternativeInitializer implements Initializer<Document, State> {
     ...
     */
    public AlternativeInitializer(CandidateRetriever index, int topK, boolean assignRandomURI) {
        super();
        this.index = index;
     ...
     * @param index
     */
    public AlternativeInitializer(CandidateRetriever index, int topK) {
